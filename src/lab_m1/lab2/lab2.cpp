...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(-1,  0,  1), glm::vec3(0.24, 0.34, 0.5), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3( 0,  0,  1), glm::vec3(0, 0.23, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1, -1,  0), glm::vec3(1, 0.19, 49), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3( 0, -1,  0), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1,  0,  0), glm::vec3(0, 0.54, 0.17), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3( 0,  0,  0), glm::vec3(0, 0.29, 0.76), glm::vec3(0.2, 0.8, 0.6))
        };
...

    {
        ...
        vertices.push_back(VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0.7, 0), glm::vec3(0.2, 0.8, 0.6)));
        for (int i = 2; i < n; i++) {
            vertices.push_back(VertexFormat(glm::vec3(cos(grades * i), sin(grades * i), 0), glm::vec3(1, 0.7, 0), glm::vec3(0.2, 0.8, 0.6)));
        }
        ...
        meshes["cerc"] = new Mesh("cerc");
        meshes["cerc"]->SetDrawMode(GL_TRIANGLE_FAN);
        meshes["cerc"]->InitFromData(vertices, indices);
    }
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //2
            VertexFormat(glm::vec3(0, 2,  0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //3
            
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //2
            VertexFormat(glm::vec3(-1, 0,  -1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //1
            VertexFormat(glm::vec3(0, 2,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //3

            VertexFormat(glm::vec3(-1, 0,  -1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //1
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //0
            VertexFormat(glm::vec3(0, 2,  0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //3

            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 0.5, 0), glm::vec3(0.2, 0.8, 0.6)), //0
            VertexFormat(glm::vec3(-1, 0,  -1), glm::vec3(1, 0.5, 0), glm::vec3(0.2, 0.8, 0.6)), //1
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 0.5, 0), glm::vec3(0.2, 0.8, 0.6)) //2
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2, 2, 2), glm::vec3(0.75f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-2, 2, -2), glm::vec3(0.75f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(3, 3, 0));

    RenderMesh(meshes["cerc"], shaders["VertexColor"], glm::vec3(0, 0, 0));
