...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-3, 2, -4));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(72), glm::vec3(0, 1, 0));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }

    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(0, -2.3, -5));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(72), glm::vec3(0, 0, 1));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(2, 0.5f, 3));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }
