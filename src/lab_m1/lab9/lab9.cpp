...
void Lab9::Update(float deltaTimeSeconds)
{
    ...
    // Why does this happen? How can you solve it?
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, mapTextures["earth"], mapTextures["earth"], true);
    }
...

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, mapTextures["random"], mapTextures["random"], true);
    }

    {
        ...
        RenderSimpleMesh(meshes["square"], shaders["LabShader"], modelMatrix, mapTextures["grass"], mapTextures["grass"], true);
    }

    //ex 8
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-0.5f, 0.5f, 0.0));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.5f));
...
void Lab9::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, Texture2D* texture1, Texture2D* texture2, bool globe)
{
    ...
    GLint is_globe = glGetUniformLocation(shader->program, "globe");
    glUniform1i(is_globe, globe);
